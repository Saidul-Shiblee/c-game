...
const MascotView = ({
      ...
      const saveData = async () => {
        if (
          ...
          await insertCollection(
            currentMascot?.version + "_" + getTodayDate(),
            {
  ...
  return (
    <div
      ...
      className="cursor-pointer flex justify-center items-center h-screen w-[55%] select-none bottom-0"
    >
      {delay ? (
        <div role="status">
          <svg
...
{
  /* <Image
          src={showSecondImage ? currentMascot?.image2 : currentMascot?.image1}
          alt="Game mascot"
          className=" select-none h-screen w-[100%]"
          // width={400}
          // height={1000}
        /> */
}
